const translations = {
  multiple: {
    active: 'Активные',
    passive: 'Пассивные',
    noteActive: 'Вводятся через ";"(точка с запятой) без пробелов.<br />Будет выводиться как сумма всех.',
    notePassive: 'Вводятся через ";"(точка с запятой) без пробелов.<br />Сумма этих сборов будет добавлена к сумме актиыных сборов, но не будет отслеживаться в реальном времени.<br />Эти сборы не будет отображаться в списке доступных для доната.',
    goalTarget: 'Цель сбора',
  },
  leverage: {
